import { AXIOS_TIMEOUT_MS, COOKIE_NAME, ONE_MONTH_MS } from "../../shared/const";
...
class OAuthService {
  ...
  private decodeState(state: string): string {
    ...
    // Validate that decoded state is a relative path to prevent open redirect
    if (!redirectUri.startsWith("/") || redirectUri.startsWith("//")) {
      throw new Error("Invalid OAuth state: redirect URI must be a relative path");
    }
    return redirectUri;
  }
